...
4. **Learn to write design documents.** Write a Markdown design document for every Lean file related to statistics or probability. [Invariance.md](Mathlib/Probability/Kernel/Invariance/Invariance.md) provides one example for [`Mathlib.Probability.Kernel.Invariance`](https://github.com/leanprover-community/mathlib4/blob/7d32461ad224e921eb05ead7ac02156702f4aa59/Mathlib/Probability/Kernel/Invariance.lean#L37-L40).
